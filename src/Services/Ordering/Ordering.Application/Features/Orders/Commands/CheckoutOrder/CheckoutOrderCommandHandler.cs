// -----------------------------------------------------------------------
// <copyright company="N/A." file="CheckoutOrderCommandHandler.cs">
// </copyright>
// <author>
...
namespace Ordering.Application.Features.Orders.Commands.CheckoutOrder
{
    public class CheckoutOrderCommandHandler : IRequestHandler<CheckoutOrderCommand, int>
    {
        ...
        {
            Email email = new Email() { To = "tom@tomfletcher.tech", Body = $"Order was created.", Subject = "Order was created" };
